...
\setkeys{Gin}{width=1.1\columnwidth}
...
bacResult = bugs(bacrag$ragged, getInits, 
                 n.chain=3, 
                 n.iter=100, parameters.to.save = names(getInits()), n.burnin=20, n.thin=4)
@
...
onResult = bugs(forBugs$ragged, getInits, 
   n.chain=3, n.iter=100, parameters.to.save = names(getInits()), n.burnin=20, n.thin=4)
...
\begin{figure}[hbt]
\begin{center}
<<ontarioMap, echo=false, fig=true,height=4,width=6>>=

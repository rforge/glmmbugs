...
<<bugsPostr,fig.cap='parameter distributions from Openbugs',fig.subcap=c('range','sd','night','intercept'),out.width='0.45\\textwidth',fig.height=4,fig.width=5,echo=FALSE,dev='pdf'>>=
